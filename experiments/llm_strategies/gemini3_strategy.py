...
STRATEGY_GROUPS = {
    ...
    # Privacy-first (Gemini-derived)
    # L1: fnlwgt, native-country, race, sex
    # L2: + marital-status, relationship
    # L3: + occupation, workclass
    "P": [
        ["fnlwgt","race_", "sex_"],
        ["native-country", "age", "marital-status"],
        ["occupation_", "relationship", "workclass_"],
    ],

    # Conservative (Gemini-derived)
    # L1: fnlwgt, native-country, race, sex, marital-status
    # L2: + relationship, occupation, workclass
    # L3: + education, education-num, capital-gain, capital-loss, hours-per-week
    "C": [
        ["fnlwgt", "native-country_", "race_", "sex_", "relationship"],
        ["martial-status_", "capital-gain", "workclass_", "capital-loss"],
        ["education_", "occupation", "age", "hours-per-week"],
    ],

    # Robust (Gemini-derived)
    # L1: fnlwgt, native-country
    # L2: + race, sex
    # L3: + marital-status, relationship
    "R": [
        ["fnlwgt", "race", "native-country_"],
        ["relationship_", "sex_", "martial-status"],
        ["workclass_","education_", "hours-per-week"],
    ],
}
