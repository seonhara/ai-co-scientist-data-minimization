...
STRATEGY_GROUPS = {
    ...
    "C": [
        ...
        ["relationship_", "occupation_", "workclass_"],
        ["education_", "education-num", "capital-gain", "capital-loss", "hours-per-week"],
    ],
